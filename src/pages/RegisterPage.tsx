...
import { User, Phone, Mail, Lock, Gift, ArrowRight, ArrowLeft, Sun, Moon } from 'lucide-react';
...
export const RegisterPage: React.FC<RegisterPageProps> = ({ onNavigate }) => {
  const { register, settings, showToast, isDarkMode, toggleDarkMode } = useApp();
    ...
    <div className={`min-h-screen flex flex-col justify-center px-4 py-8 relative overflow-hidden transition-colors ${
      ...
      <div className="w-full max-w-md mx-auto relative z-10">
        ...
        <div className="text-center space-y-2 mb-8 flex flex-col items-center">
          ...
          <h1 className="text-lg font-black text-slate-900 dark:text-white tracking-tight drop-shadow-xs">
        ...
        <div className="bg-white dark:bg-[#0c1222]/90 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/50 dark:shadow-black/40 border border-slate-200 dark:border-sky-500/20 space-y-4">
          ...
          {/* Login link */}
          <div className="text-center pt-3 text-xs text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800 font-medium">
